...
<input value="<%=annonce.getId() %>" name="idDemanderAnnonce" form="formDemande" id="idDemanderAnnonce"/>
<div class="confirmVenteOverlay" style="">
    ...
    <div class="confirmVenteOverlayFooter">
        ...
        <button class="btn btn-primary postOtherDemande">Poster une autre annonce</button>
