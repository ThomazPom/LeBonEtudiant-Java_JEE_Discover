...
<form method="post" name="formDemande" id="formDemande" action="AjaxServlet">
    <input hidden value="<%=(nwann) ? "-1" : anc.getId() %>" name="idAnnonce" id="idDemandeAnnonce"/>
            ...
            <table><tr>
                    <td style="width: 300px">
                        <span class="input-group-addon" id="basic-addon1" >
                            ...
                            <input value="<%=(nwann) ? "3000" : anc.getPrix() %>" name="amountAnnonce" type="text" id="hidden-amount-annonce-demande" hidden>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-warning effacerForm-Demande"><span class="glyphicon glyphicon-refresh"></span>&nbsp;Réinitialiser</button>
